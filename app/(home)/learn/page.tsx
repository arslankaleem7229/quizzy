...
const LearnPage = () => {
  ...
  return (
    <main className="flex w-full max-w-7xl mx-auto min-h-screen bg-(--background) text-(--foreground)">
      <section className="flex flex-1 flex-col px-4 pb-10 pt-6 lg:px-14">
        <div className="mt-8 flex flex-col gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="ml-2 rounded-full bg-white/15 px-3 py-1 text-xs text-white">
              556
            </span>
          </div>

          <div className="flex flex-col rounded-xl bg-[#2E3856] px-8 py-5 gap-5 min-h-[60vh]">
            <div>
            ...
            <div className="flex-3 flex flex-col gap-3 justify-end">
              <p className="text-sm text-gray-300">Choose an answer</p>
                    ...
                    <button
                      ...
                      className={`flex rounded-lg border-2 px-4 py-3 gap-5 items-center text-left transition ${
                        isSelected
                          ...
                          : "border-white/15 bg-transparent text-gray-200 hover:border-white/40"
                      }`}
                    >
            ...
            <div className="flex-1 flex flex-wrap items-center gap-4 text-sm text-gray-300">
              <button className="inline-flex items-center gap-2 rounded-full border border-white/15 px-4 py-2 text-white">
