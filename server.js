...
var app = (0, next_1.default)({ dev: dev, dir: path_1.default.resolve(__dirname) });
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    io.on("connection", function (socket) {
                        ...
                        socket.on("subscribe-job", function (jobId) {
                            socket.join("job:".concat(jobId));
                            console.log("Subscribed to job ".concat(jobId));
                        });
                    ...
                    server.listen(port, "0.0.0.0", function () {
                        console.log("Server ready on http://0.0.0.0:".concat(port));
