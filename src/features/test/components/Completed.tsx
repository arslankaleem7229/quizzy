...
import { useAttemptResult } from "../hooks/useAttemptResults";
...
export function Completed({
  ...
  const { maxScore, obtainedScore } = useAttemptResult(attemptId);
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-10 md:flex-row">
          <ResultStats
            totalQuestions={isAttempt ? maxScore ?? 0 : completedCount ?? 0}
